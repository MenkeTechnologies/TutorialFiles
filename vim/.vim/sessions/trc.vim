...
" Vim session script.
" Created by session.vim 2.13.1 on 15 February 2018 at 19:57:58.
...
setlocal fdn=20
setlocal fen
let s:l = 64 - ((33 * winheight(0) + 34) / 69)
...
setlocal fdn=20
setlocal fen
let s:l = 20 - ((15 * winheight(0) + 34) / 69)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
20
...
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
exe '1resize ' . ((&lines * 32 + 36) / 72)
exe '2resize ' . ((&lines * 36 + 36) / 72)
argglobal
setlocal fdm=marker
setlocal fde=0
setlocal fmr={{{,}}}
