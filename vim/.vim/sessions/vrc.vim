...
" Vim session script.
" Created by session.vim 2.13.1 on 02 March 2018 at 13:42:18.
...
if !exists('g:colors_name') || g:colors_name != 'blackboard' | colorscheme blackboard | endif
call setqflist([])
let SessionLoad = 1
...
337
silent! normal! zo
let s:l = 847 - ((58 * winheight(0) + 35) / 70)
