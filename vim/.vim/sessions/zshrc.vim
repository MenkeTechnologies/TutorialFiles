...
" Vim session script.
" Created by session.vim 2.13.1 on 02 March 2018 at 02:04:46.
...
setlocal fdn=20
setlocal fen
let s:l = 994 - ((34 * winheight(0) + 35) / 70)
...
setlocal fdn=20
setlocal fen
let s:l = 35 - ((33 * winheight(0) + 35) / 70)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
35
...
setlocal fdn=20
setlocal fen
let s:l = 42 - ((23 * winheight(0) + 35) / 70)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
