...
" Vim session script.
" Created by session.vim 2.13.1 on 11 February 2018 at 22:42:35.
...
if !exists('g:colors_name') || g:colors_name != 'kellys' | colorscheme kellys | endif
call setqflist([])
let SessionLoad = 1
...
setlocal fdn=20
setlocal fen
let s:l = 412 - ((31 * winheight(0) + 33) / 66)
