...
" Vim session script.
" Created by session.vim 2.13.1 on 07 February 2018 at 23:56:12.
...
if !exists('g:colors_name') || g:colors_name != 'neverland' | colorscheme neverland | endif
call setqflist([])
let SessionLoad = 1
...
setlocal fdn=20
setlocal fen
let s:l = 138 - ((0 * winheight(0) + 33) / 66)
